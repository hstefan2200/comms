...
class BPSKModulator:
    def __init__(self, carrier_freq=1000, sample_rate=8000):
    ...
    def modulate(self, bits):
        ...
        signal = np.repeat(symbols, samples_per_symbol) * np.cos(2 * np.pi * self.fc * t)
...
class BPSKDemodulator:
    ...
    def demodulate(self, signal):
        ...
        for i in range(num_symbols):
            ...
            end_index = (i + 1) * samples_per_symbol
