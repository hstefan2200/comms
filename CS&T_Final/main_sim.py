...
File Transmission:
[X] Images (compressed)
[X] Audio (intelligible)
[X] Combined transmission
[X] Error resilient
"""
...
[X] Sound signal transmission (speech/audio)
[X] Image signal transmission (MATLAB logo)
[X] Combined audio+image transmission  
[X] AWGN channel with variable SNR
[X] BER analysis with theoretical comparison
[X] Large file handling with compression
[X] Error-resistant protocols
[X] Intelligent audio processing for speech clarity
...
"""
        ...
        # Save summary to file with UTF-8 encoding to handle special characters
